...
import utils
from experiments import abstract_experiment as ex


class Bufflehead(ex.Experiment):
    ...
    def get_pset(self, num_predictors, variable_type_indices, variable_names, variable_dict):
        pset = sp.SimpleParametrizedPrimitiveSet("MAIN", num_predictors, variable_type_indices, variable_names)

...
do
    ...
    gdal_translate -ot Int16 -b 1 -projwin 10 71.3 25.66667 66.56289 -projwin_srs EPSG:4326 -a_srs EPSG:4326 "mosaics/"$id"_mosaic_250m 16 days $d"".tif" "mosaics/"$id"_clipped_mosaic_250m 16 days $d"".tif"
done

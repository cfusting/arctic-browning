...
validate_reliability(data_files, reliability_files, date_pattern)
for year in range(args.start_year, args.end_year + 1):
    data_files_in_range, reliability_files_in_range = filter_files_in_range(data_files, reliability_files, year,
                                                                            ...
                                                                            args.date_regex)
    space_time = retrieve_space_time(data_files_in_range, reliability_files_in_range, date_pattern)
